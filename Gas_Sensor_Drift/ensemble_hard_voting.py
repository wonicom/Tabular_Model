# -*- coding: utf-8 -*-
"""ensemble.ipynb_setting02의 hard voting

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1bvygoSOg6l8BPyzRzX5uB36wpkbyZgjL
"""
...
for f in range(1,10) :
  ...
  all_preds = [tabnet_preds, svm_preds, pred_lstm]
  all_preds_int = [pred.argmax(axis=1) for pred in all_preds]
  ensemble_preds = np.apply_along_axis(lambda x: np.bincount(x).argmax(), axis=1, arr=np.transpose(all_preds_int)).astype(np.int64)
